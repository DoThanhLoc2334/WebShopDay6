                            ...
                            <tbody>
                                ...
                                foreach ($cart as $id => $item): ?>
                                    <tr>
                                        ...
                                        <td><?= $item['name'] ?></td>
                                        <td>
                                            <input type="number" class="form-control" id="quantity_<?= $id ?>" value="<?= $item['quantity'] ?>" />
                                            <button class="btn btn-primary btn-sm btn-update-quantity" data-id="<?= $id ?>">Update</button>
                                        </td>
                                        <td><?= number_format($item['price'], 2, ".", ",") ?> vnđ</td>
                                        <td><?= number_format($item['quantity'] * $item['price'], 2, ".", ",") ?> vnđ</td>
                                        <td>
                                            <a href="#" class="btn btn-danger btn-delete-product" data-id="<?= $id ?>"><i class="fa fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
